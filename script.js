...
async function searchNutrition(){
 ...
 let adv=[], dis=[];
 if(category==="Healthy"){
  adv.push("Prepared using nutritious ingredients and supports overall health.");
 }
 if(category==="Junk"){
  dis.push("Contains ingredients or nutrients that may affect health if consumed frequently.");
 }
 if(n.sugar>10) dis.push("High sugar content may increase blood sugar levels.");
