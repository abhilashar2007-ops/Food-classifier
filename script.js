...
function loadModel(){
 const url=document.getElementById("tmurl").value;
 document.getElementById("tmstatus").innerText = url ? 
 "Model URL loaded (ready to integrate prediction)" : "Please paste a valid model URL";
}
